...
class UserProfile(models.Model):
    ...
    user_college = models.ForeignKey(College, verbose_name='学院', on_delete=models.CASCADE, null=True)
    ...
    user_address = models.CharField(max_length=100, verbose_name='地址', null=True)
